    ...
    return ((Component) => {
        const WithComponent = (props) => {
            const results = reduce_1(options, (acc, option, name) => {
                ...
                const hookOptionType = (hookOption && (Array.isArray(hookOption) ? 'array' : isPlainObject_1(hookOption) && 'object')) || null;
                const hookCallback = hookOptionType === 'array'
                    ? hookOption[0]
                ...
                const hookParameters = hookOptionType === 'array'
                    ? hookOption.slice(1)
...
exports.useStateSafe = useStateSafe;
